...
Protected Module FormatCodePreferences
	#tag CompatibilityFlags = not TargetWeb and not TargetHasGUI
	#tag Note, Name = About
	...
	#tag Constant, Name = KeywordsToTitleCase, Type = String, Dynamic = False, Default = \"Integer\x2C Byte\x2C Short\x2C Int8\x2C Int16\x2C Int32\x2C Int64\x2C UInt8\x2C UInt16\x2C UInt32\x2C UInt64\x2C Double\x2C Single\x2C String\x2C Variant\n\nDictionary\x2C Date\n\nTrue\x2C False\n\nClose\n\nRaiseEvent", Scope = Protected
	#tag EndConstant
